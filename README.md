...
An OPC UA Cloud- or Edge-based Action reference implementation which queries data from Azure Data Explorer and calls UA Cloud Commander on the Edge via Kafka.
